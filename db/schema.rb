...
ActiveRecord::Schema.define(version: 2019_01_04_170407) do
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.float "latitude_sign_in", default: 0.0, null: false
    t.float "longitude_sign_in", default: 0.0, null: false
